...
var crf = require('./cmap-reader-factory.js');  //root + 'src/core/cmap-reader-factory.js');

var pdfJs = require('./pdf.js');  //root + 'lib/pdf.js');
pdfJs.PDFJS.workerSrc = './pdf.worker.js';  //root + 'lib/pdf.worker.js';
pdfJs.PDFJS.disableWorker = false;

pdfJs.PDFJS.cMapUrl = './cmaps/';  //root + 'lib/cmaps/';
